...
import com.raawdroid.mcropimagepicker.R
import com.raawdroid.mcropimagepicker.databinding.ActivityMainBinding
import com.raawdroid.image_picker.ImagePicker
import com.raawdroid.image_picker.util.IntentUtils
import com.raawdroid.mcropimagepicker.util.FileUtil
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        binding.contentMain.contentProfile.imgProfile.setOnClickListener { showImage(it) }
        binding.contentMain.contentProfile.fabAddPhoto.setOnClickListener { pickProfileImage(it) }
        binding.contentMain.contentProfile.imgProfileCode.setOnClickListener { showImageCode(it) }
        binding.contentMain.contentProfile.imgProfileInfo.setOnClickListener { showImageInfo(it) }

        binding.contentMain.contentGalleryOnly.imgGalleryCode.setOnClickListener { showImageCode(it) }
        binding.contentMain.contentGalleryOnly.imgGalleryInfo.setOnClickListener { showImageInfo(it) }
        binding.contentMain.contentGalleryOnly.imgGallery.setOnClickListener { showImage(it) }
        binding.contentMain.contentGalleryOnly.fabAddGalleryPhoto.setOnClickListener { pickGalleryImage(it) }

        binding.contentMain.contentCameraOnly.imgCameraCode.setOnClickListener { showImageCode(it) }
        binding.contentMain.contentCameraOnly.imgCameraInfo.setOnClickListener { showImageInfo(it) }
        binding.contentMain.contentCameraOnly.imgCamera.setOnClickListener { showImage(it) }
        binding.contentMain.contentCameraOnly.fabAddCameraPhoto.setOnClickListener { pickCameraImage(it) }
    }
    ...
    fun showImageCode(view: View) {
        val resource = when (view) {
            binding.contentMain.contentProfile.imgProfileCode -> R.drawable.img_profile_code
            binding.contentMain.contentCameraOnly.imgCameraCode -> R.drawable.img_camera_code
            binding.contentMain.contentGalleryOnly.imgGalleryCode -> R.drawable.img_gallery_code
            else -> 0
        }
